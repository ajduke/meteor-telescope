Template.telescope_user_item.helpers({
  ...
  posts: function(){
    return Telescope_Posts.find({'userId':this._id});
  },
  comments: function(){
    return Telescope_Comments.find({'userId':this._id});
  },
...
Template.telescope_user_item.events({
  ...
  'click .delete-link': function(e, instance){
    ...
    if(Meteor.userId() === instance.data._id){
      clearSeenErrors()
      throwError('Cant delete yourself as you are admin...')
      return;
    }
