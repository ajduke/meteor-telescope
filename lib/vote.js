  ...
  Meteor.methods({
    upvotePost: function(post, user){
      return upvoteItem.call(this, Telescope_Posts, post);
    },
    downvotePost: function(post, user){
      return downvoteItem.call(this, Telescope_Posts, post);
    },
    cancelUpvotePost: function(post, user){
      return cancelUpvote.call(this, Telescope_Posts, post);
    },
    cancelDownvotePost: function(post, user){
      return cancelDownvote.call(this, Telescope_Posts, post);
    },
    upvoteComment: function(comment, user){
      return upvoteItem.call(this, Telescope_Comments, comment);
    },
    downvoteComment: function(comment, user){
      return upvoteItem.call(this, Telescope_Comments, comment);
    },
    cancelUpvoteComment: function(comment, user){
      return cancelUpvote.call(this, Telescope_Comments, comment);
    },
    cancelDownvoteComment: function(comment, user){
      return cancelDownvote.call(this, Telescope_Comments, comment);
    }
  });
