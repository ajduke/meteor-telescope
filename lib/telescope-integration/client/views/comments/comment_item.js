...
Template.telescope_comment_item.events({
  ...
  'click .sh-square-comment': function(e, instance){
    e.preventDefault();
    if(!Meteor.user()){
//      Router.go('/'+baseUrl+'/signin');
  ...
  'click div.sh-square-comment.upvoted .upvote': function(e, instance){
    e.preventDefault();
    if(!Meteor.user()){
//      Router.go('/'+baseUrl+'/signin');
      throwError("Please log in first");
  ...
  'click div.sh-square-comment.not-downvoted .downvote': function(e, instance){
    e.preventDefault();
    if(!Meteor.user()){
//      Router.go('/'+baseUrl+'/signin');
      throwError("Please log in first");
  ...
  'click div.sh-square-comment.downvoted .downvote': function(e, instance){
    e.preventDefault();
    if(!Meteor.user()){
//      Router.go('/'+baseUrl+'/signin');
      throwError("Please log in first");
