Telescope_Notifications = new Meteor.Collection('telescopeNotifications');

Telescope_Notifications.allow({
  ...
  switch(event){
    ...
    case 'accountApproved':
      var n = {
        ...
        html: 'Welcome to '+getSetting('title')+'!<br/> Your account has just been approved. <a href="'+Meteor.absoluteUrl()+baseUrl+'">Start posting.</a>'
      }
      break;
...
Meteor.methods({
  markAllNotificationsAsRead: function() {
    Telescope_Notifications.update(
